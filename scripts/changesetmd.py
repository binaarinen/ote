...
#        cursor = connection.cursor(psycopg2.extras.DictCursor)
        try:
        ...
        returnStatus = 0
        try:
            serverState = yaml.load(urllib.request.urlopen(BASE_REPL_URL + "state.yaml"))
...
if __name__ == '__main__':
    ...
    conn = psycopg2.connect(dbname=args.dbName, user=args.dbUser, password=args.dbPass, host=args.dbHost, port=args.dbPort)
